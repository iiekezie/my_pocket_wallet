...
class _EditScreenState extends State<EditScreen> {
  ...
  Future<void> _updation(BuildContext context, String id) async {
    ...
    if (amount == 0 || amount.isNegative) {
      ...
      if (amount != widget.data.amount ||
          categoryTypeName != widget.data.categoryTypeName ||
          selectedDateNew != widget.data.selectedDate ||
