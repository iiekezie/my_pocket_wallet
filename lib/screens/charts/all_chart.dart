...
class _AllChartState extends State<AllChart> {
  ...
  Future<void> _selectPeriod(
      BuildContext context, List<TransactionModel> data) async {
    ...
    if (customSelectedFirstDate == null) {
      ...
      if (customSelectedLastDate == null) {
        ...
        final List<AllChartData> customPeriodList =
            allChartLogic(customPeriodListGenerate);
  ...
  void _showBottomSheet(BuildContext context,
      List<AllChartData> customPeriodList, String heading) {
